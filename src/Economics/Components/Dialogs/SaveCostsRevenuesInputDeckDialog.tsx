...
const economicsCostsRevenuesTitlesSelector = createDeepEqualSelector(
  (state: RootState) =>
    state.applicationReducer["allFormTitles"]["economicsCostsRevenuesTitles"],
  (title) => title
);
...
const SaveCostsRevenuesInputDeckDialog: React.FC<DialogStuff> = (props) => {
  ...
  const storedTitles = useSelector(economicsCostsRevenuesTitlesSelector);
