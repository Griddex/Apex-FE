...
function TransitionComponent(props: JSX.IntrinsicAttributes & CollapseProps) {
...
// const StyledTreeItem = withStyles((theme) => ({}))((props) => {
...
export default function ForecastTreeView() {
  ...
  return (
    <div className={classes.container}>
      ...
      >
        <TreeItem
          className={clsx(classes.group, classes.iconContainer)}
          TransitionComponent={TransitionComponent}
          nodeId="1"
          label="Network_1"
        >
          {forecastRuns &&
            forecastRuns.map((forecastRun, i) => {
              const Id = "2";
