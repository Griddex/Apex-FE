...
export const successDialogParameters: DialogStuff = {
  name: "Existing_Production_Prioritization_Success_Dialog",
  title: "Existing Production Prioritization Retrieval Success",
  type: "textDialog",
  show: true,
  exclusive: true,
  maxWidth: "xs",
  dialogText: "Existing Production Prioritization Retrieval Successful",
  iconType: "success",
...
export const failureDialogParameters: DialogStuff = {
  name: "Existing_Production_Prioritization_Failure_Dialog",
  title: "Sensitivities Retrieval Failure",
  type: "textDialog",
  show: true,
  exclusive: true,
  maxWidth: "xs",
  dialogText: "Existing Production Prioritization Retrieval failure",
  iconType: "error",
