...
import ExistingProjects from "../../Routes/ExistingProjects";
...
const ExistingProjectsDialog = (props: DialogStuff) => {
  const dispatch = useDispatch();
  ...
  return (
    ...
    >
      ...
      >
        <ExistingProjects containerStyle={{ boxShadow: "none" }} />
      </DialogContent>
...
export default ExistingProjectsDialog;
